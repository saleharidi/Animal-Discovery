...
const species = [
    ...
    { url: 'gaint-otter.jpg', text: 'The Giant Otter is a large river otter found in South America’s wetlands and rivers. It is endangered due to habitat loss, pollution, and hunting' }
]
...
let animal = {
    ...
    displayAnimal: function () {
        ...
        descValue.innerHTML = animalInfo[0].description
    },
